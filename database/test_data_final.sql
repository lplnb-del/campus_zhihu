...
-- 插入测试标签（使用IGNORE避免重复）
INSERT IGNORE INTO `biz_tag` (`name`, `description`, `icon`, `color`, `use_count`) VALUES
...
-- 插入测试点赞记录（使用IGNORE避免重复）
INSERT IGNORE INTO `biz_like_record` (`user_id`, `target_type`, `target_id`) VALUES
...
-- 插入测试收藏记录（使用IGNORE避免重复）
INSERT IGNORE INTO `biz_collection` (`user_id`, `target_type`, `target_id`) VALUES
(6, 1, 6), (7, 1, 6), (8, 1, 6),
(7, 1, 7), (8, 1, 7), (9, 1, 7),
(8, 1, 8), (9, 1, 8), (10, 1, 8),
(9, 1, 9), (10, 1, 9), (11, 1, 9),
